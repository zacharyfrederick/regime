"""
Data loading for a single fold. Expects conn to have rebal_dates table registered
(e.g. month_ends or week_ends from get_rebal_dates).
"""
...
MONTHLY_UNIVERSE_WHERE = (
    "AND (f.marketcap_daily IS NOT NULL AND f.marketcap_daily >= 1000)"
