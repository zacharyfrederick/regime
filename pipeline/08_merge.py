...
def main() -> None:
    ...
    _empty_fundamental_pit = """
        SELECT u.ticker, u.date,
               ...
               CAST(NULL AS DOUBLE) AS roic_level,
    ...
    con.execute(
        ...
        SELECT
            ...
            p.momentum_skew_60d,
            f.ncfo_r2_5y, f.ncfo_r2_10y, f.ncfo_cagr_5y, f.ncfo_cagr_10y, f.ncfo_pct_positive, f.ncfo_r2_adjusted,
            f.fcf_r2_5y, f.fcf_r2_10y, f.fcf_cagr_5y, f.fcf_cagr_10y, f.fcf_pct_positive, f.fcf_r2_adjusted, f.fcf_ncfo_r2_delta,
            f.ncfo_r2_adjusted_arcsinh, f.fcf_r2_adjusted_arcsinh,
